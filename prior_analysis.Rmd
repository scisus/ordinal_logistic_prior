...
knitr::kable(noproblem_models_gam, caption="model parameterization-dataset combinations that never had an (very obvious) problem")
```
...
`r nrow(problems_indir)` out of 27 models had problems with Rhat or neff_ratio in 1-6 of the model runs. Only model 4 had neff_ratio problems.
