...
The induced ordinal logistic prior on the cutpoints is a sort of top-down prior.
...
```{r plotGammaRecaptureoverall, caption="Number of parameters recaptured by each model, averaged across model runs", fig.width=7, fig.height=6}
